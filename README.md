...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/vector-lite.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/vector-lite)
...
```bash
php artisan vendor:publish --tag="vector-lite-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="vector-lite-views"
```
